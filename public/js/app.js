(function () {
    var pusher = new Pusher('de95eab4d71f410e9e3d', {
    ...
    const helpers = {
        // clears chat message window
        clearChatMessages: () => {
            $('#chat-msgs').html('')
        },

        // displays new chat message in current window
        ...
        // shows user's chat messages in general chat window
